...
# # torch cuda 11.3
python -m pip install torch==1.10.2 torchvision torchaudio --index-url https://download.pytorch.org/whl/cpu

# dgl cuda 11.3
# add a source if prefered: -i https://pypi.tuna.tsinghua.edu.cn/simple/
python -m pip install dgl==1.1.0 -f https://data.dgl.ai/wheels/cpu/repo.html
